...
<div class="w3-services py-5" id="services">
    <div class="container py-lg-3">
        ...
        <div class=" w3-services-grids mt-lg-5 mt-4">
                <p class="text-justify">Lorem ipsum dolor sit amet, init sed adipisci ngelit. In a et euismod faucibus quam, a sodales er
                    ...
                    <div class="row mt-5 pt-3">
                        ...
                        <div class="col-lg-4 col-md-6 mt-lg-0 mt-5 pt-lg-0 pt-3">
                            <div class="card text-center">
                                ...
                                <div class="open-description">
                                    <p>Planejamento mensal, trimensal ou anual de cada midia. Assessorar conteúdo das redes sociais, acompanhar em tempo real as interações dos usuários</p>
                                    <a href="#read" class="text-primary">Saiba mais</a>
                                </div>
                            </div>
                        </div>
