...
<section id="team" class="border-light border-top pt-5 pb-5 bg-white">
    <div class="container pb-5">
        ...
        <hr width="30%">
        <p class="lead text-center text-dark font-italic mb-5">Conheça o time que faz a ATENA AGÊNCIA mais forte.</p>
        <br>
        <div class="row">
            <!-- Team member -->
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    ...
                                    <p class="card-text">. Diretoria Executiva, Diretoria de Desenvolvimento e Criação,
                                        Designer Gráfico e Desenvolvedor.</p>
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid"
                                            src="https://dcnt5qvi2hv76.cloudfront.net/b12410825/resize_cache/94/23365dd92c1f65a6eb81283cfddb6812/main/c5f/c5faaa6c0e0c0e986cd0ddf198dabcb7/WIN_20200201_23_15_52_Pro.jpg"
                                            alt="card image"></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    ...
                                    <p class="card-text"> Diretoria Executiva, Diretoria de Comunicação e Publicidade,
                                        Designer gráfica.</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid"
                                            src="https://dcnt5qvi2hv76.cloudfront.net/b12410825/resize_cache/158/23365dd92c1f65a6eb81283cfddb6812/main/5ff/5ff969aabc10bfdabeee9f526a2f5f16/54247938_272856233661767_3938140866699113286_n.jpg"
                                            alt="card image"></p>
                                    <h4 class="card-title">Jeferson Alves</h4>
                                    <p class="card-text">Gestor comercial</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="equipe/tauan.jpg" alt="card image"></p>
                                    <h4 class="card-title">Tauan Almeida</h4>
                                    <p class="card-text">Programador</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid"
                                            src="https://dcnt5qvi2hv76.cloudfront.net/b12410825/resize_cache/328/23365dd92c1f65a6eb81283cfddb6812/main/a3e/a3ee80aa875d64359ad271f2856c5505/Foto.PNG"
                                            alt="card image"></p>
                                    <h4 class="card-title">Maikon Damasceno</h4>
                                    <p class="card-text">Estagiário</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid"
                                            src="https://dcnt5qvi2hv76.cloudfront.net/b12410825/resize_cache/254/23365dd92c1f65a6eb81283cfddb6812/main/d96/d96b910aeedfcb54822037d874749947/IMG_20191028_221844_022.jpg"
                                            alt="card image"></p>
                                    <h4 class="card-title">Isla Gonçalves</h4>
                                    <p class="card-text">Estagiário</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid"
                                            src="https://dcnt5qvi2hv76.cloudfront.net/b12410825/resize_cache/308/23365dd92c1f65a6eb81283cfddb6812/main/99f/99fe2ba97f7d8a4a4f374e67ca8c16d9/foto_quele.jpg"
                                            alt="card image"></p>
                                    <h4 class="card-title">Quele Santos</h4>
                                    <p class="card-text">Estagiário</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
